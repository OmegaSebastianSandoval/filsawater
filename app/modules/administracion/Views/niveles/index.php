        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="nivel_nivel" value="<?php echo $this->getObjectVariable($this->filters, 'nivel_nivel') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>código</label>
		            ...
		            <input type="text" class="form-control" name="nivel_codigo" value="<?php echo $this->getObjectVariable($this->filters, 'nivel_codigo') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="nivel_porcentaje" value="<?php echo $this->getObjectVariable($this->filters, 'nivel_porcentaje') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="nivel_estado" value="<?php echo $this->getObjectVariable($this->filters, 'nivel_estado') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->nivel_id; ?>
					<tr>
						<td><?=$content->nivel_nivel;?></td>
						<td><?=$content->nivel_codigo;?></td>
						<td><?=$content->nivel_porcentaje;?></td>
						<td><?=$content->nivel_estado;?></td>
						<td class="text-end">
							<div>
