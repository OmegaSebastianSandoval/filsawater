			...
			<div class="row">
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_documento; ?>" name="pedido_documento" id="pedido_documento" class="form-control"   >
					</label>
				...
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_fecha; ?>" name="pedido_fecha" id="pedido_fecha" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_total; ?>" name="pedido_total" id="pedido_total" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_subtotal; ?>" name="pedido_subtotal" id="pedido_subtotal" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_procentaje_descuento; ?>" name="pedido_procentaje_descuento" id="pedido_procentaje_descuento" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_descuento; ?>" name="pedido_descuento" id="pedido_descuento" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_iva; ?>" name="pedido_iva" id="pedido_iva" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_estado; ?>" name="pedido_estado" id="pedido_estado" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
				...
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_ciudad; ?>" name="pedido_ciudad" id="pedido_ciudad" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
				...
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_nombre; ?>" name="pedido_nombre" id="pedido_nombre" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
				...
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_respuesta; ?>" name="pedido_respuesta" id="pedido_respuesta" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_validacion; ?>" name="pedido_validacion" id="pedido_validacion" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_validacion2; ?>" name="pedido_validacion2" id="pedido_validacion2" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_entidad; ?>" name="pedido_entidad" id="pedido_entidad" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
				<div class="col-12 col-md-3 form-group">
					...
					<label class="input-group">
						...
						<input type="text" value="<?= $this->content->pedido_porcentaje_iva; ?>" name="pedido_porcentaje_iva" id="pedido_porcentaje_iva" class="form-control"   >
					</label>
					<div class="help-block with-errors"></div>
				</div>
			</div>
