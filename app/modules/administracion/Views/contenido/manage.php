    ...
    <div class="content-dashboard">
      ...
      <div class="row">
        ...
        <?php if ($padre == 0 || $padre == '') { ?>
          ...
          <div class="col-2 form-group">
            <label class="control-label">Caja tipografica</label>
            <br>
            <input type="checkbox" name="contenido_caja" value="1" class="form-control switch-form"
              <?php if ($this->getObjectVariable($this->content, 'contenido_caja') == 1) {
                echo "checked";
              } ?>></input>
            <div class="help-block with-errors"></div>
          </div>
