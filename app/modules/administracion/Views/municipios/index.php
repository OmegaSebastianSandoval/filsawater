        ...
        <div class="content-dashboard">
            <div class="row">
				<div class="col-3">
		            ...
		            <input type="text" class="form-control" name="municipio" value="<?php echo $this->getObjectVariable($this->filters, 'municipio') ?>"></input>
		            </label>
		        </div>
				<div class="col-3">
		            <label>estado</label>
				...
				<div class="col-3">
		            <label>departamento_id</label>
		            <label class="input-group">
							<div class="input-group-prepend">
								<span class="input-group-text input-icono " ><i class="fas fa-pencil-alt"></i></span>
							</div>
		            <input type="text" class="form-control" name="departamento_id" value="<?php echo $this->getObjectVariable($this->filters, 'departamento_id') ?>"></input>
		            </label>
		        </div>
                <div class="col-3">
                    <label>&nbsp;</label>
	...
	<div class="content-dashboard">
		...
		<table class=" table table-striped  table-hover table-administrator text-left">
			...
			<tbody>
				...
				<?php $id =  $content->id_municipio; ?>
					<tr>
						<td><?=$content->municipio;?></td>
						<td><?=$content->estado;?></td>
						<td><?=$content->departamento_id;?></td>
						<td class="text-end">
							<div>
