        ...
        <div class="content-dashboard">
            <div class="row">
				...
				<div class="col-2">
	                ...
	                <input type="text" class="form-control" name="correos_informacion_fecha" value="<?php echo $this->getObjectVariable($this->filters, 'correos_informacion_fecha') ?>"></input>
	                    </label>
	            </div>
				<div class="col-2">
			...
			<tbody>
				...
				<?php $id =  $content->correo_informacion_id; ?>
					<tr>
						...
						<td><?=$content->correos_informacion_estado;?></td>
						<td class="text-end">
							<div>
