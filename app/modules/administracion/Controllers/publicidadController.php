...
class Administracion_publicidadController extends Administracion_mainController
{
  ...
  private function getPublicidadseccion()
  {
    ...
    // HOME
    $array['1'] = 'Banners Home Filsa';
    // $array['2'] = 'Banners Home Servicios';
    // $array['3'] = 'Banners Home Desanilizadoras';

    $array['2'] = 'Banners Nosotros';
    $array['3'] = 'Banners Contacto';
    $array['4'] = 'Banners Política de calidad';
    $array['5'] = 'Banners Plantas';
    $array['6'] = 'Banners Servicios';
    $array['7'] = 'Banners Proyectos';
    $array['8'] = 'Banners Soluciones';
    $array['9'] = 'Banners Filter Caps';
