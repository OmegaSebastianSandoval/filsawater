...
class Administracion_configController extends Administracion_mainController
{
	...
	{
		$data = array();
		if($this->_getSanitizedParam("configuracion_iva") == '' ) {
			$data['configuracion_iva'] = '0';
		} else {
			$data['configuracion_iva'] = $this->_getSanitizedParam("configuracion_iva");
		}
		return $data;
	}
	/**
    ...
    protected function getFilter()
    {
        ...
        if (Session::getInstance()->get($this->namefilter)!="") {
            $filters =(object)Session::getInstance()->get($this->namefilter);
            if ($filters->configuracion_iva != '') {
                $filtros = $filtros." AND configuracion_iva LIKE '%".$filters->configuracion_iva."%'";
            }
		}
        return $filtros;
    }
    ...
    protected function filters()
    {
        if ($this->getRequest()->isPost()== true) {
            ...
            $parramsfilter = array();
					$parramsfilter['configuracion_iva'] =  $this->_getSanitizedParam("configuracion_iva");Session::getInstance()->set($this->namefilter, $parramsfilter);
        }
